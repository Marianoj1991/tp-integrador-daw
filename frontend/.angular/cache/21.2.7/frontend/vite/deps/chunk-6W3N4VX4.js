  ...
  if (a(e)) {
    ...
    if (G(a2, k)) {
      let n = a2.replaceAll(k, (l2) => {
        let c2 = l2.replace(/{|}/g, "").split(".").filter((m3) => !s3.some((d) => G(m3, d)));
        return `var(${ae(r, re(c2.join("-")))}${s(i2) ? `, ${i2}` : ""})`;
      });
...
function le(e, t) {
  ...
  function r(n, l2) {
    ...
    for (; c2 <= n.length; ) {
      ...
      if ((g2 === '"' || g2 === "'" || g2 === "`") && n[c2 - 1] !== "\\" && (d = d === g2 ? null : g2), !d && (g2 === "(" && u++, g2 === ")" && u--, (g2 === "," || c2 === n.length) && u === 0)) {
        let f = m3.trim();
        f.startsWith("dt(") ? o.push(le(f, l2)) : o.push(s3(f)), m3 = "", c2++;
        continue;
      }
      g2 !== void 0 && (m3 += g2), c2++;
    }
  ...
  for (let n = i2.length - 1; n >= 0; n--) {
    let [l2, o] = i2[n], c2 = e.slice(l2 + 3, o), m3 = r(c2, t), d = t(...m3);
...
var ue = (e = {}, t, r, s3) => {
  if (t) {
    ...
    return s3 === "value" || l(s3) && l2 === "strict" ? S.getTokenValue(t) : Y3(o, void 0, n, [i2.excludedKeyRegex], r);
  }
  return "";
};
function ar(e, ...t) {
  if (e instanceof Array) {
    let r = e.reduce((s3, i2, a2) => {
      var n;
      return s3 + i2 + ((n = m2(t[a2], { dt: E })) != null ? n : "");
    }, "");
    return le(r, E);
  }
  return m2(e, { dt: E });
...
function de(e, t = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m3) {
      let g2 = m3[u], f = ve(g2), p = G(u, a2) ? Q(d) : Q(d, re(u));
      if (i(f)) o.push({ node: f, path: p });
      else {
        let y = ae(p), R2 = Y3(f, p, s3, [a2]);
        Re(l2, y, R2);
        let T = p;
...
var b = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  let { preset: a2, options: n } = t, l2, o, c2, m3, d, u, g2;
  if (s(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te3, extend: re2 } = a2, f = te3 || {}, { colorScheme: K } = f, A = v(f, ["colorScheme"]), x2 = re2 || {}, { colorScheme: X } = x2, G2 = v(x2, ["colorScheme"]), p = K || {}, { dark: U } = p, B = v(p, ["dark"]), y = X || {}, { dark: I } = y, H2 = v(y, ["dark"]), W2 = s(L) ? this._toVariables({ primitive: L }, n) : {}, q2 = s(A) ? this._toVariables({ semantic: A }, n) : {}, Z = s(B) ? this._toVariables({ light: B }, n) : {}, pe = s(U) ? this._toVariables({ dark: U }, n) : {}, fe = s(G2) ? this._toVariables({ semantic: G2 }, n) : {}, ye = s(H2) ? this._toVariables({ light: H2 }, n) : {}, Se = s(I) ? this._toVariables({ dark: I }, n) : {}, [Me, ze] = [(R2 = W2.declarations) != null ? R2 : "", W2.tokens], [Ke, Xe] = [(T = q2.declarations) != null ? T : "", q2.tokens || []], [Ge, Ue] = [(j = Z.declarations) != null ? j : "", Z.tokens || []], [Be, Ie] = [(O2 = pe.declarations) != null ? O2 : "", pe.tokens || []], [He, We] = [(M = fe.declarations) != null ? M : "", fe.tokens || []], [qe, Ze] = [(z2 = ye.declarations) != null ? z2 : "", ye.tokens || []], [Fe, Je] = [(V = Se.declarations) != null ? V : "", Se.tokens || []];
    ...
    d = `${et}${tt}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g2 = m2(a2.css, { dt: E });
  }
  ...
  if (s(t) && r.transform !== "strict") {
    let y = e.replace("-directive", ""), m3 = t, { colorScheme: R2, extend: T, css: j } = m3, O2 = v(m3, ["colorScheme", "extend", "css"]), d = T || {}, { colorScheme: M } = d, z2 = v(d, ["colorScheme"]), u = R2 || {}, { dark: V } = u, L = v(u, ["dark"]), g2 = M || {}, { dark: te3 } = g2, re2 = v(g2, ["dark"]), K = s(O2) ? this._toVariables({ [y]: h(h({}, O2), z2) }, r) : {}, A = s(L) ? this._toVariables({ [y]: h(h({}, L), re2) }, r) : {}, X = s(V) ? this._toVariables({ [y]: h(h({}, V), te3) }, r) : {}, [G2, U] = [(f = K.declarations) != null ? f : "", K.tokens || []], [B, I] = [(x2 = A.declarations) != null ? x2 : "", A.tokens || []], [H2, W2] = [(p = X.declarations) != null ? p : "", X.tokens || []], q2 = this.transformCSS(y, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y, H2, "dark", "variable", r, i2, a2, n);
    l2 = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U, ...I, ...W2])], c2 = m2(j, { dt: E });
  }
  ...
  var c2, m3;
  let a2 = e.replace("-directive", ""), { preset: n, options: l2 } = t, o = ((c2 = n == null ? void 0 : n.components) == null ? void 0 : c2[a2]) || ((m3 = n == null ? void 0 : n.directives) == null ? void 0 : m3[a2]);
  ...
  let n = this.getCommon({ name: e, theme: t, params: r, set: i2, defaults: a2 }), l2 = Object.entries(s3).reduce((o, [c2, m3]) => o.push(`${c2}="${m3}"`) && o, []).join(" ");
  return Object.entries(n || {}).reduce((o, [c2, m3]) => {
    if (i(m3) && Object.hasOwn(m3, "css")) {
      let d = Y2(m3.css), u = `${c2}-variables`;
  ...
  var c2;
  let n = { name: e, theme: t, params: r, set: i2, defaults: a2 }, l2 = (c2 = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : c2.css, o = Object.entries(s3).reduce((m3, [d, u]) => m3.push(`${d}="${u}"`) && m3, []).join(" ");
  ...
  let a2 = function(l2, o = {}, c2 = []) {
    ...
    return l(o.binding) && delete o.binding, c2.pop(), { colorScheme: l2, path: this.path, paths: o, value: m3.includes("__UNRESOLVED__") ? void 0 : m3 };
  }, n = (l2, o, c2) => {
    Object.entries(l2).forEach(([m3, d]) => {
      let u = G(m3, t.variable.excludedKeyRegex) ? o : o ? `${o}.${oe2(m3)}` : oe2(m3), g2 = c2 ? `${c2}.${m3}` : m3;
      i(d) ? n(d, u, g2) : (i2[u] || (i2[u] = { paths: [], computed: (f, x2 = {}, p = []) => {
        ...
        if (f && f !== "none") for (let y = 0; y < i2[u].paths.length; y++) {
          let R2 = i2[u].paths[y];
          if (R2.scheme === f) return R2.computed(f, x2.binding, p);
        }
  ...
  var l2;
  let i2 = ((o) => o.split(".").filter((m3) => !G(m3.toLowerCase(), r.variable.excludedKeyRegex)).join("."))(t), a2 = t.includes("colorScheme.light") ? "light" : t.includes("colorScheme.dark") ? "dark" : void 0, n = [(l2 = e[i2]) == null ? void 0 : l2.computed(a2)].flat().filter((o) => o);
  return n.length === 1 ? n[0].value : n.reduce((o = {}, c2) => {
    let u = c2, { colorScheme: m3 } = u, d = v(u, ["colorScheme"]);
    return o[m3] = d, o;
  }, void 0);
  ...
  if (s(t)) {
    ...
    if (s3 !== "style") {
      ...
      t = r === "dark" ? c2.reduce((m3, { type: d, selector: u }) => (s(u) && (m3 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l2, d, t)), m3), "") : C2(l2 != null ? l2 : ":root,:host", t);
    }
    if (o) {
      let c2 = { name: "primeui", order: "primeui" };
      i(o) && (c2.name = m2(o.name, { name: e, type: s3 })), s(c2.name) && (t = C2(`@layer ${c2.name}`, t), a2 == null || a2.layerNames(c2.name));
    }
    return t;
  }
  return "";
