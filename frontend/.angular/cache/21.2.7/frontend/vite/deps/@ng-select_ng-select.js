...
var NgDropdownPanelComponent = class _NgDropdownPanelComponent {
  constructor() {
    ...
    this.popover = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "popover"
    } : (
      /* istanbul ignore next */
      {}
  ...
  _handleWindowScroll() {
    ...
    this._zone.runOutsideAngular(() => {
      fromEvent(this._document, "scroll", {
        capture: true,
        passive: true
      }).pipe(takeUntilDestroyed(this._destroyRef), auditTime(0, SCROLL_SCHEDULER)).subscribe(() => {
        this._updateXPosition();
        this._updateYPosition();
      });
    });
...
var NgOptionComponent = class _NgOptionComponent {
  constructor() {
    ...
    this.isInitialized = signal(false, ...ngDevMode ? [{
      debugName: "isInitialized"
    }] : (
      /* istanbul ignore next */
      []
    ));
...
var NgSelectComponent = class _NgSelectComponent {
  constructor() {
    ...
    this._ariaLabelDropdown = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_ariaLabelDropdown"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.ariaLabelDropdown = linkedSignal(() => this._ariaLabelDropdown(), ...ngDevMode ? [{
      debugName: "ariaLabelDropdown"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._ariaLabel = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_ariaLabel"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.ariaLabel = linkedSignal(() => this._ariaLabel(), ...ngDevMode ? [{
      debugName: "ariaLabel"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._markFirst = input(true, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_markFirst"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.markFirst = linkedSignal(() => this._markFirst(), ...ngDevMode ? [{
      debugName: "markFirst"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._placeholder = input(this.config.placeholder, __spreadProps(__spreadValues({}, ngDevMode ? {
    ...
    this.placeholder = linkedSignal(() => this._placeholder(), ...ngDevMode ? [{
      debugName: "placeholder"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._fixedPlaceholder = input(true, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_fixedPlaceholder"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.fixedPlaceholder = linkedSignal(() => this._fixedPlaceholder(), ...ngDevMode ? [{
      debugName: "fixedPlaceholder"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._notFoundText = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_notFoundText"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.notFoundText = linkedSignal(() => this._notFoundText(), ...ngDevMode ? [{
      debugName: "notFoundText"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._typeToSearchText = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_typeToSearchText"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.typeToSearchText = linkedSignal(() => this._typeToSearchText(), ...ngDevMode ? [{
      debugName: "typeToSearchText"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._preventToggleOnRightClick = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_preventToggleOnRightClick"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.preventToggleOnRightClick = linkedSignal(() => this._preventToggleOnRightClick(), ...ngDevMode ? [{
      debugName: "preventToggleOnRightClick"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._addTagText = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_addTagText"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.addTagText = linkedSignal(() => this._addTagText(), ...ngDevMode ? [{
      debugName: "addTagText"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._loadingText = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_loadingText"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.loadingText = linkedSignal(() => this._loadingText(), ...ngDevMode ? [{
      debugName: "loadingText"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._clearAllText = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_clearAllText"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.clearAllText = linkedSignal(() => this._clearAllText(), ...ngDevMode ? [{
      debugName: "clearAllText"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._dropdownPosition = input("auto", __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_dropdownPosition"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.dropdownPosition = linkedSignal(() => this._dropdownPosition(), ...ngDevMode ? [{
      debugName: "dropdownPosition"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._appendTo = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_appendTo"
    } : (
      /* istanbul ignore next */
      {}
    ...
    this.appendTo = linkedSignal(() => this._appendTo(), ...ngDevMode ? [{
      debugName: "appendTo"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._outsideClickEvent = input(this.config.outsideClickEvent, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_outsideClickEvent"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.outsideClickEvent = linkedSignal(() => this._outsideClickEvent(), ...ngDevMode ? [{
      debugName: "outsideClickEvent"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._loading = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_loading"
    } : (
      /* istanbul ignore next */
      {}
    ...
    this.loading = linkedSignal(() => this._loading(), ...ngDevMode ? [{
      debugName: "loading"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._closeOnSelect = input(true, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_closeOnSelect"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.closeOnSelect = linkedSignal(() => this._closeOnSelect(), ...ngDevMode ? [{
      debugName: "closeOnSelect"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._hideSelected = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_hideSelected"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.hideSelected = linkedSignal(() => this._hideSelected(), ...ngDevMode ? [{
      debugName: "hideSelected"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._selectOnTab = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_selectOnTab"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.selectOnTab = linkedSignal(() => this._selectOnTab(), ...ngDevMode ? [{
      debugName: "selectOnTab"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._openOnEnter = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_openOnEnter"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.openOnEnter = linkedSignal(() => this._openOnEnter(), ...ngDevMode ? [{
      debugName: "openOnEnter"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._maxSelectedItems = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_maxSelectedItems"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.maxSelectedItems = linkedSignal(() => this._maxSelectedItems(), ...ngDevMode ? [{
      debugName: "maxSelectedItems"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._groupBy = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_groupBy"
    } : (
      /* istanbul ignore next */
      {}
    ...
    this.groupBy = linkedSignal(() => this._groupBy(), ...ngDevMode ? [{
      debugName: "groupBy"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._groupValue = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_groupValue"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.groupValue = linkedSignal(() => this._groupValue(), ...ngDevMode ? [{
      debugName: "groupValue"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._bufferAmount = input(4, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_bufferAmount"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.bufferAmount = linkedSignal(() => this._bufferAmount(), ...ngDevMode ? [{
      debugName: "bufferAmount"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._virtualScroll = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_virtualScroll"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.virtualScroll = linkedSignal(() => this._virtualScroll(), ...ngDevMode ? [{
      debugName: "virtualScroll"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._selectableGroup = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_selectableGroup"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.selectableGroup = linkedSignal(() => this._selectableGroup(), ...ngDevMode ? [{
      debugName: "selectableGroup"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._tabFocusOnClearButton = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_tabFocusOnClearButton"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.tabFocusOnClearButton = linkedSignal(() => this._tabFocusOnClearButton(), ...ngDevMode ? [{
      debugName: "tabFocusOnClearButton"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._selectableGroupAsModel = input(true, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_selectableGroupAsModel"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.selectableGroupAsModel = linkedSignal(() => this._selectableGroupAsModel(), ...ngDevMode ? [{
      debugName: "selectableGroupAsModel"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._searchFn = input(null, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_searchFn"
    } : (
      /* istanbul ignore next */
      {}
    ...
    this.searchFn = linkedSignal(() => this._searchFn(), ...ngDevMode ? [{
      debugName: "searchFn"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._trackByFn = input(null, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_trackByFn"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.trackByFn = linkedSignal(() => this._trackByFn(), ...ngDevMode ? [{
      debugName: "trackByFn"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._clearOnBackspace = input(true, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_clearOnBackspace"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.clearOnBackspace = linkedSignal(() => this._clearOnBackspace(), ...ngDevMode ? [{
      debugName: "clearOnBackspace"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._labelForId = input(null, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_labelForId"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.labelForId = linkedSignal(() => this._labelForId(), ...ngDevMode ? [{
      debugName: "labelForId"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._inputAttrs = input({}, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_inputAttrs"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.inputAttrs = linkedSignal(() => this._inputAttrs(), ...ngDevMode ? [{
      debugName: "inputAttrs"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._tabIndex = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_tabIndex"
    } : (
      /* istanbul ignore next */
      {}
    ...
    this.tabIndex = linkedSignal(() => this._tabIndex(), ...ngDevMode ? [{
      debugName: "tabIndex"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._readonly = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_readonly"
    } : (
      /* istanbul ignore next */
      {}
    ...
    this.readonly = linkedSignal(() => this._readonly(), ...ngDevMode ? [{
      debugName: "readonly"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._searchWhileComposing = input(true, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_searchWhileComposing"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.searchWhileComposing = linkedSignal(() => this._searchWhileComposing(), ...ngDevMode ? [{
      debugName: "searchWhileComposing"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._minTermLength = input(0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_minTermLength"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.minTermLength = linkedSignal(() => this._minTermLength(), ...ngDevMode ? [{
      debugName: "minTermLength"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._editableSearchTerm = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
    ...
    this.editableSearchTerm = linkedSignal(() => this._editableSearchTerm(), ...ngDevMode ? [{
      debugName: "editableSearchTerm"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._ngClass = input(null, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_ngClass"
    } : (
      /* istanbul ignore next */
      {}
    ...
    this.ngClass = linkedSignal(() => this._ngClass(), ...ngDevMode ? [{
      debugName: "ngClass"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._typeahead = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_typeahead"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.typeahead = linkedSignal(() => this._typeahead(), ...ngDevMode ? [{
      debugName: "typeahead"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._multiple = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_multiple"
    } : (
      /* istanbul ignore next */
      {}
    ...
    this.multiple = linkedSignal(() => this._multiple(), ...ngDevMode ? [{
      debugName: "multiple"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._addTag = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_addTag"
    } : (
      /* istanbul ignore next */
      {}
    ...
    this.addTag = linkedSignal(() => this._addTag(), ...ngDevMode ? [{
      debugName: "addTag"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._searchable = input(true, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_searchable"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.searchable = linkedSignal(() => this._searchable(), ...ngDevMode ? [{
      debugName: "searchable"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._clearable = input(true, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_clearable"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.clearable = linkedSignal(() => this._clearable(), ...ngDevMode ? [{
      debugName: "clearable"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._clearKeepsDisabledOptions = input(true, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_clearKeepsDisabledOptions"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.clearKeepsDisabledOptions = linkedSignal(() => this._clearKeepsDisabledOptions(), ...ngDevMode ? [{
      debugName: "clearKeepsDisabledOptions"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._deselectOnClick = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_deselectOnClick"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.deselectOnClick = linkedSignal(() => this._deselectOnClick(), ...ngDevMode ? [{
      debugName: "deselectOnClick"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._clearSearchOnAdd = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_clearSearchOnAdd"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.clearSearchOnAdd = linkedSignal(() => this._clearSearchOnAdd(), ...ngDevMode ? [{
      debugName: "clearSearchOnAdd"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._compareWith = input(void 0, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_compareWith"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.compareWith = linkedSignal(() => this._compareWith(), ...ngDevMode ? [{
      debugName: "compareWith"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._keyDownFn = input((_) => true, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_keyDownFn"
    } : (
      /* istanbul ignore next */
      {}
    )), {
    ...
    this.keyDownFn = linkedSignal(() => this._keyDownFn(), ...ngDevMode ? [{
      debugName: "keyDownFn"
    }] : (
      /* istanbul ignore next */
      []
    ));
    this._popover = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
      debugName: "_popover"
    } : (
      /* istanbul ignore next */
      {}
    ...
    this.popover = linkedSignal(() => this._popover(), ...ngDevMode ? [{
      debugName: "popover"
    }] : (
      /* istanbul ignore next */
      []
    ...
    this._editableSearchTermActive = computed(() => this.editableSearchTerm() && !this.multiple(), ...ngDevMode ? [{
      debugName: "_editableSearchTermActive"
    }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      inputs: {
        _ariaLabelDropdown: [1, "ariaLabelDropdown", "_ariaLabelDropdown"],
        _ariaLabel: [1, "ariaLabel", "_ariaLabel"],
        _markFirst: [1, "markFirst", "_markFirst"],
        _placeholder: [1, "placeholder", "_placeholder"],
        _fixedPlaceholder: [1, "fixedPlaceholder", "_fixedPlaceholder"],
        _notFoundText: [1, "notFoundText", "_notFoundText"],
        _typeToSearchText: [1, "typeToSearchText", "_typeToSearchText"],
        _preventToggleOnRightClick: [1, "preventToggleOnRightClick", "_preventToggleOnRightClick"],
        _addTagText: [1, "addTagText", "_addTagText"],
        _loadingText: [1, "loadingText", "_loadingText"],
        _clearAllText: [1, "clearAllText", "_clearAllText"],
        _dropdownPosition: [1, "dropdownPosition", "_dropdownPosition"],
        _appendTo: [1, "appendTo", "_appendTo"],
        _outsideClickEvent: [1, "outsideClickEvent", "_outsideClickEvent"],
        _loading: [1, "loading", "_loading"],
        _closeOnSelect: [1, "closeOnSelect", "_closeOnSelect"],
        _hideSelected: [1, "hideSelected", "_hideSelected"],
        _selectOnTab: [1, "selectOnTab", "_selectOnTab"],
        _openOnEnter: [1, "openOnEnter", "_openOnEnter"],
        _maxSelectedItems: [1, "maxSelectedItems", "_maxSelectedItems"],
        _groupBy: [1, "groupBy", "_groupBy"],
        _groupValue: [1, "groupValue", "_groupValue"],
        _bufferAmount: [1, "bufferAmount", "_bufferAmount"],
        _virtualScroll: [1, "virtualScroll", "_virtualScroll"],
        _selectableGroup: [1, "selectableGroup", "_selectableGroup"],
        _tabFocusOnClearButton: [1, "tabFocusOnClearButton", "_tabFocusOnClearButton"],
        _selectableGroupAsModel: [1, "selectableGroupAsModel", "_selectableGroupAsModel"],
        _searchFn: [1, "searchFn", "_searchFn"],
        _trackByFn: [1, "trackByFn", "_trackByFn"],
        _clearOnBackspace: [1, "clearOnBackspace", "_clearOnBackspace"],
        _labelForId: [1, "labelForId", "_labelForId"],
        _inputAttrs: [1, "inputAttrs", "_inputAttrs"],
        _tabIndex: [1, "tabIndex", "_tabIndex"],
        _readonly: [1, "readonly", "_readonly"],
        _searchWhileComposing: [1, "searchWhileComposing", "_searchWhileComposing"],
        _minTermLength: [1, "minTermLength", "_minTermLength"],
        _editableSearchTerm: [1, "editableSearchTerm", "_editableSearchTerm"],
        _ngClass: [1, "ngClass", "_ngClass"],
        _typeahead: [1, "typeahead", "_typeahead"],
        _multiple: [1, "multiple", "_multiple"],
        _addTag: [1, "addTag", "_addTag"],
        _searchable: [1, "searchable", "_searchable"],
        _clearable: [1, "clearable", "_clearable"],
        _clearKeepsDisabledOptions: [1, "clearKeepsDisabledOptions", "_clearKeepsDisabledOptions"],
        _deselectOnClick: [1, "deselectOnClick", "_deselectOnClick"],
        _clearSearchOnAdd: [1, "clearSearchOnAdd", "_clearSearchOnAdd"],
        _compareWith: [1, "compareWith", "_compareWith"],
        _keyDownFn: [1, "keyDownFn", "_keyDownFn"],
        _popover: [1, "popover", "_popover"],
      ...
      template: function NgSelectComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          ɵɵelementEnd()();
          ɵɵconditionalCreate(12, NgSelectComponent_Conditional_12_Template, 8, 22, "ng-dropdown-panel", 18);
