...
var Scroller = class _Scroller extends BaseComponent {
  ...
  viewInit() {
    if (isPlatformBrowser(this.platformId) && !this.initialized) {
      if (ot(this.elementViewChild?.nativeElement)) {
        this.setInitialState();
        this.setContentEl(this.contentEl);
        this.init();
        this.defaultWidth = Nt(this.elementViewChild?.nativeElement);
        this.defaultHeight = Tt(this.elementViewChild?.nativeElement);
        this.defaultContentWidth = Nt(this.contentEl);
    ...
    if (this._autoSize && !this.d_loading) {
      Promise.resolve().then(() => {
        if (this.contentEl) {
          ...
          const [contentWidth, contentHeight] = [Nt(this.contentEl), Tt(this.contentEl)];
          contentWidth !== this.defaultContentWidth && (this.elementViewChild.nativeElement.style.width = "");
          contentHeight !== this.defaultContentHeight && (this.elementViewChild.nativeElement.style.height = "");
          const [width, height] = [Nt(this.elementViewChild.nativeElement), Tt(this.elementViewChild.nativeElement)];
...
//# sourceMappingURL=chunk-XU5K6ODY.js.map
